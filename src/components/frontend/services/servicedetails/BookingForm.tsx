    ...
    <>
      <form onSubmit={handleSubmit} className="space-y-6 max-w-md mx-auto px-4">
        ...
        <div>
          ...
          {!formData.date ? (
            <p className="text-gray-500 italic">Please select a date to see available slots.</p>
          ) : loadingSlots ? (
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-xl shadow-xl max-w-sm w-full text-center">
            <h2 className="text-2xl font-bold mb-4 text-rose-600">Booking Sent!</h2>
            <p className="text-gray-700 mb-6">Thank you! We will contact you soon to confirm your booking.</p>
            <button
